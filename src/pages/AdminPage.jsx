...
import { onAuditLogChange, onGlobalStatsChange, onUsersChange } from '../services/firestoreService';
        ...
        {activeAdminTab === 'Audit' ? (
          ...
          <div className="glass-card rounded-3xl overflow-hidden border-white/[0.05]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6 overflow-y-auto max-h-[600px] custom-scrollbar">
              {users.map(u => (
                <div key={u.id} className="p-4 rounded-2xl bg-white/[0.03] border border-white/[0.08] hover:border-indigo-500/30 transition-all flex gap-4 items-center">
